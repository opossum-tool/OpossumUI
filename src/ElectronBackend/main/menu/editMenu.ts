...
import { INITIALLY_DISABLED_ITEMS_IDS } from './initiallyDisabledMenuItems';
...
function getSelectAll(): MenuItemConstructorOptions {
  return {
    ...
    role: 'selectAll',
    id: INITIALLY_DISABLED_ITEMS_IDS.selectAll,
    enabled: false,
  };
}
...
function getSearchAttributions(webContents: Electron.WebContents) {
  return {
    ...
    id: INITIALLY_DISABLED_ITEMS_IDS.searchAttributions,
    enabled: false,
  };
}
...
function getSearchSignals(webContents: Electron.WebContents) {
  return {
    ...
    id: INITIALLY_DISABLED_ITEMS_IDS.searchSignals,
    enabled: false,
  };
}
...
function getSearchResources(webContents: Electron.WebContents) {
  return {
    ...
    id: INITIALLY_DISABLED_ITEMS_IDS.searchResourcesAll,
    enabled: false,
  };
}
...
function getSearchLinkedResources(webContents: Electron.WebContents) {
  return {
    ...
    id: INITIALLY_DISABLED_ITEMS_IDS.searchResourceLinked,
    enabled: false,
  };
}

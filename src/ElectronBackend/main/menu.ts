...
function getFileMenu(mainWindow: BrowserWindow) {
...
function getViewMenu(qaMode: null | boolean): MenuItemConstructorOptions {
  return {
    label: 'View',
    submenu: [
      {
...
function getHelpMenu(webContents: Electron.WebContents) {
  return {
    label: 'Help',
    submenu: [
      {

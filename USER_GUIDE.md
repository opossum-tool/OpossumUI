...
To view project statistics, open the `File` menu and select `Project Statistics`. This opens a new window that shows a table that summarizes the license data of the project by source, and a table that summarizes the number of 1st party and follow-up attributions.
